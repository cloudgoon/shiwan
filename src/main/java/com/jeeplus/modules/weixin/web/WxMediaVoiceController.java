 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/weixin/wxMediaVoice")
public class WxMediaVoiceController extends BaseController {
    @Autowired
    ...
    public String list() {
        return "modules/weixin/mediaFiles/voice/voiceList";
    }
    ...
    public Map<String, Object> data(WxMediaFiles wxMediaFiles, HttpServletRequest request, HttpServletResponse response, Model model) {
        wxMediaFiles.setMediaType(MediaType.Voice.toString());
    ...
    public String form(WxMediaFiles wxMediaFiles, Model model) {
        ...
        return "modules/weixin/mediaFiles/voice/voiceForm";
    }
    ...
    public String look(WxMediaFiles wxMediaFiles, Model model) {
        model.addAttribute("wxMediaFiles", wxMediaFiles);
        return "modules/weixin/mediaFiles/voice/voiceLook";
    }
    ...
    public String save(WxMediaFiles wxMediaFiles, Model model, RedirectAttributes redirectAttributes) throws Exception {
        ...
        if (account == null) {
            ...
            return "redirect:" + Global.getAdminPath() + "/weixin/wxMediaVoice/?repage";
        }
        if (StringUtils.isBlank(wxMediaFiles.getMediaId())) {//如果ID是空为添加
            ...
            String materialType = MediaType.Voice.toString();
            //将图片同步到微信，返回mediaId
