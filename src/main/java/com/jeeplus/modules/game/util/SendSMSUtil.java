...
public class SendSMSUtil {
    ...
    static final String accessKeyId = "LTAIJ1K2pEPZNopD";
    static final String accessKeySecret = "EqfQ2FaU7aymemfqckiwWemqZAJ5m8";
    /**
     *
     * @param phones	发送的手机号（多个手机号用“,”号隔开，如String phones = "13877901111,13877902222";）
     * @param 	，格式如String params = "{\"name\":\"李四\",\"code\":\"1234\"}";
     * @return
    ...
    public static SendSmsResponse sendSms(String phones,String jsonObjectStringParams) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("田米匠心");
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_121856438");
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为String param = "{\"name\":\"张三\",\"code\":\"1234\"}";
        request.setTemplateParam("{\"number\":\""+jsonObjectStringParams+"\"}");
