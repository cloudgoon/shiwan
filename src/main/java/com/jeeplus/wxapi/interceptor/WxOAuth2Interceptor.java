 ...
 *
 */
package com.jeeplus.wxapi.interceptor;
...
import com.jeeplus.wxapi.process.OAuthScope;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (StringUtils.isBlank(openid)) {//没有，通过微信页面授权获取
            ...
            if (!StringUtils.isBlank(code)) {//如果request中包括code，则是微信回调
                ...
                log.info("-------------------------------------preHandle-----<3-1>-------------------mpAccount:" + wxAccount.getAccount());
                ...
                String url = WxApi.getOAuthCodeUrl(wxAccount.getAppid(), redirectUrl, OAuthScope.Base.toString(), state);
