...
public class Identities {
    ...
    public static String getTimeMillisSequence() {
        ...
        for (int i = 0; i < difBit; i++) {
            preFix = StringUtils.concat(new Object[]{preFix, "0"});
        }
        long last = atomicLongID.getAndIncrement() % 10000L + 10000L;
        return StringUtils.concat(new Object[]{DateUtil.changeDateTOStr5(new Date(), "yyyyMMddHHmmssSSS"), preFix, nanoTimeStr, Long.valueOf(last)});
    }
