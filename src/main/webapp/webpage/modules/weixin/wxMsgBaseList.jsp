...
<body>
	...
	<div class="panel-heading">
		<h3 class="panel-title">微信消息列表</h3>
	</div>
		...
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="wxMsgBase" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:input path="msgType" htmlEscape="false" maxlength="20"  class=" form-control"/>
			</div>
		 <div class="col-xs-12 col-sm-6 col-md-4">
	...
	<div id="toolbar">
			<shiro:hasPermission name="weixin:wxMsgBase:add">
				<a id="add" class="btn btn-primary" href="${ctx}/weixin/wxMsgBase/form" title="微信消息"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			...
			<shiro:hasPermission name="weixin:wxMsgBase:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/weixin/wxMsgBase/import" method="post" enctype="multipart/form-data"
