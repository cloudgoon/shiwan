...
$(document).ready(function() {
	$('#wxMsgNewsTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/weixin/wxMsgNews/form?id=" + row.id;
	  ...
	  $('#wxMsgNewsTable').on('check.bs.table uncheck.bs.table load-success.bs.table ' +
            ...
            $('#edit').prop('disabled', $('#wxMsgNewsTable').bootstrapTable('getSelections').length!=1);
        });
  ...
  function edit(){
	  window.location = "${ctx}/weixin/wxMsgNews/form?id=" + getIdSelections();
  }
