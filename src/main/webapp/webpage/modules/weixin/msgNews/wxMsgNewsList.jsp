        ...
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="wxMsgNews"
            ...
            <div id="toolbar">
                <shiro:hasPermission name="weixin:wxMsgNews:add">
                    <a id="add" class="btn btn-primary" href="${ctx}/weixin/wxMsgNews/form" title="单图文管理"><i
                            class="glyphicon glyphicon-plus"></i>新建单图文</a>
                </shiro:hasPermission>
                <shiro:hasPermission name="weixin:wxMsgNews:edit">
