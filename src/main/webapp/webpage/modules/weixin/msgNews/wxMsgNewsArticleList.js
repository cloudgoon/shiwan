...
$(document).ready(function() {
	$('#wxMsgNewsArticleTable').bootstrapTable({
		  ...
		  //请求方法
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/weixin/wxMsgNewsArticle/form?id=" + row.id;
			...
			,{
		        ...
		        ,formatter:function(value, row , index){
		        	return "<a href='${ctx}/weixin/wxMsgNewsArticle/form?id="+row.id+"'>"+value+"</a>";
		         }
	  ...
	  $('#wxMsgNewsArticleTable').on('check.bs.table uncheck.bs.table load-success.bs.table ' +
            ...
            $('#edit').prop('disabled', $('#wxMsgNewsArticleTable').bootstrapTable('getSelections').length!=1);
        });
			...
			jp.open({
			    ...
			    btn: ['下载模板','确定', '关闭'],
				    btn1: function(index, layero){
					  window.location='${ctx}/weixin/wxMsgNewsArticle/import/template';
				  },
  ...
  function edit(){
	  window.location = "${ctx}/weixin/wxMsgNewsArticle/form?id=" + getIdSelections();
  }
