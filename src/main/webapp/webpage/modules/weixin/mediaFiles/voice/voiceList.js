...
$(document).ready(function() {
		  ...
		  //请求方法
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/weixin/wxMediaVoice/form?id=" + row.id;
		        ...
		        checkbox: true
                   ...
                   ,{
                       ...
                       formatter: function operateFormatter(value, row, index) {
                           return '<a href="#" onclick="jp.openDialogView(\'预览\', \'${ctx}/weixin/wxMediaVoice/look?id='+row.id+'\',\'800px\', \'650px\')"><i class="fa fa-search-plus"></i> 预览</a>';
                       }
                   }
		     ]
  ...
  function edit(){
	  window.location = "${ctx}/weixin/wxMediaVoice/form?id=" + getIdSelections();
  }
