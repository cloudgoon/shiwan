...
$(document).ready(function() {
		  ...
		  //请求方法
               ...
               onContextMenuItem: function(row, $el){
                   if($el.data("item") == "edit"){
                   	window.location = "${ctx}/weixin/wxMediaImage/form?id=" + row.id;
               ...
               columns: [{
		        checkbox: true
                   ...
                   ,{
                       ...
                       sortable: true,
                       formatter:function(value, row , index){
                           return "<a href='"+value+"' target='_blank' title='点击查看原图'><img class='fans-portrait' width='30px' height='30px' src=" + value + " />";
                       }
  ...
  function edit(){
	  window.location = "${ctx}/weixin/wxMediaImage/form?id=" + getIdSelections();
  }
