...
<head>
    ...
    <%@include file="imageList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">图片管理列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div id="toolbar">
                <shiro:hasPermission name="weixin:wxMediaFiles:add">
                    <a id="add" class="btn btn-primary" href="${ctx}/weixin/wxMediaImage/form" title="图片管理"><i
                            class="glyphicon glyphicon-plus"></i> 新建</a>
                    <a id="add1" class="btn btn-primary" title="同步图片"><i
                            class="fa fa-arrow-down"></i>批量同步图片</a>
                </shiro:hasPermission>
