...
<body><div class="wrapper wrapper-content">
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title">视频管理列表</h3>
        </div>
        <div class="panel-body">
            ...
            <div id="toolbar">
                <shiro:hasPermission name="weixin:wxMediaFiles:add">
                    <a id="add" class="btn btn-primary" href="${ctx}/weixin/wxMediaVideo/form" title="视频管理"><i
                            class="glyphicon glyphicon-plus"></i> 新建</a>
                    <a id="add1" class="btn btn-primary" title="同步视频"><i
                            class="fa fa-arrow-down"></i>批量同步视频</a>
                </shiro:hasPermission>
