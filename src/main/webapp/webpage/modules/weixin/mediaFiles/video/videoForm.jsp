            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <a class="panelButton" href="${ctx}/weixin/wxMediaVideo/"><i class="ti-angle-left"></i> 返回</a>
                    </h3>
                </div>
                <div class="panel-body">
                    <form:form id="inputForm" modelAttribute="wxMediaFiles" action="${ctx}/weixin/wxMediaVideo/save"
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <div class="ibox float-e-margins">
                                    <p style="color: red">根据微信官方要求，视频格式：MP4,10MB.</p>
