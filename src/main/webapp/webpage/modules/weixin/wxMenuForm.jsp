	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title"> 
				<a class="panelButton" href="${ctx}/weixin/wxMenu"><i class="ti-angle-left"></i> 返回</a>
			</h3>
		</div>
		...
		<sys:message content="${message}"/>	
				<div class="form-group">
					<label class="col-sm-2 control-label">消息类型： click - 事件消息；view - 链接消息 ：</label>
					<div class="col-sm-10">
						<form:input path="mtype" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">event_type：</label>
					<div class="col-sm-10">
						<form:input path="eventType" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">input_code：</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">msg_type：</label>
					<div class="col-sm-10">
						<form:input path="msgType" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">msg_id：</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<form:input path="gid" htmlEscape="false"    class="form-control "/>
					</div>
				</div>
				<div class="form-group">
		...
		<c:if test="${fns:hasPermission('weixin:wxMenu:edit') || isAdd}">
