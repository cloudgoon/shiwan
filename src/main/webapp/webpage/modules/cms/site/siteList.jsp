        ...
        <div class="panel-body">
            ...
            <div class="accordion-group">
                <div id="collapseTwo" class="accordion-body collapse">
                    <div class="accordion-inner">
                        <form:form id="searchForm" modelAttribute="site" class="form form-horizontal well clearfix">
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <label class="label-item single-overflow pull-left" title="站点名称：">站点名称：</label>
                                <form:input path="name" htmlEscape="false" maxlength="100" class=" form-control"/>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <label class="label-item single-overflow pull-left" title="站点标题：">站点标题：</label>
            ...
            <div id="toolbar">
                <shiro:hasPermission name="cms:site:add">
                    <a id="add" class="btn btn-primary" href="${ctx}/cms/site/form" title="站点信息"><i
