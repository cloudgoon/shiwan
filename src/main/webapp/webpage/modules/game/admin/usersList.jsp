...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="users" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="真实姓名：">真实姓名：</label>
	...
	<!-- 工具栏 -->
	<div id="toolbar">
			<shiro:hasPermission name="game:admin:users:add">
			...
			<shiro:hasPermission name="game:admin:users:import">
				...
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/game/admin/users/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="usersTable"   data-toolbar="#toolbar"></table>
